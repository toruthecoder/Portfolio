    ...
    <div className='Abou'>
      <div className="about">
        ...
        <div className="info">
          ...
          <h4>Student of : AIOU</h4>
          <h4>Semester : 2</h4>
        <a href='/CV.pdf' download='CV.pdf'><button className='btn2'>Download CV</button></a>
        </div>
      </div>
      <div className="text1">
        ...
        <br />
        <p>My toolkit includes <b>HTML</b>, <b>CSS</b>, <b>JavaScript</b>, and <b>React</b> <b>MongoDB</b>, <b>Express.js</b>, <b>Node.js</b>, <b>Vite</b>, <b>Vercel</b> to bring ideas to the Frontend and Backend. My journey in self-learning has honed my problem-solving skills and my ability to quickly adapt to new challenges. I leverage <b>Git</b> and <b>GitHub</b> for efficient version control and collaborative workflows.</p>
        <br />
